...
The macOS executable will be located in `target/<your_mac_target>/release/finder`.
...
`finder` automatically respects rules defined in `.gitignore` and `.ignore` files.
